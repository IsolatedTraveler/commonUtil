import {
  ...
  magicCheckAuthV2, magicData2, getJtPhisSystem, getSystemVal, bbPrint, getBrowserParam, setBrowserParam, 
  errorTrace, openDialog, openMsgBox, skip, dealLogin, paramget, setWebName, getMd5, encryption, down, loadJs, 
