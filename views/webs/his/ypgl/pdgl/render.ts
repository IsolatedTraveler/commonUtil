...
import {
  ...
  setWebName, getMd5, encryption, down, loadJs, readFile, loadStyle, alertMsg, confirmMsg, getLayui, load, loaded,
  loading, openPage, getName, getRouterW, redirect, router, session, local, setPageTemp, tempData, getAllUrl,
