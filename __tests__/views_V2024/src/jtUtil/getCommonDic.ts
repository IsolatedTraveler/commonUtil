import { DICS, DIC_URL, getAuthorization, getCommonDic, initializeComboboxBase } from '../../../../views_V2024/main'
...
(global as any).initializeComboboxBase = () => {}
(window as any).initializeComboboxBase = () => {}
describe('filterDicData function', () => {
  beforeEach(() => {
    jest.spyOn(global, 'XMLHttpRequest').mockImplementation(() => {
      return new XMLHttpRequest() as any
    });
    jest.spyOn(global as any, 'initializeComboboxBase').mockImplementation(() => {});
    jest.spyOn(window as any, 'initializeComboboxBase').mockImplementation(() => {});
