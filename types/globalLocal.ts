import {
  ...
  dealLogin, paramget, setWebName, getMd5, encryption, down, loadJs, loadJsJudge, loadStyle, readFile, 
  uploadInputFile, alertMsg, confirmMsg, getLayui, load, loaded, loading, openPage, getName, getRouterW, 
  redirect, router, session, local, setPageTemp, tempData, getAllUrl, getUploadUrl, dealsUrl, getUrl, 
