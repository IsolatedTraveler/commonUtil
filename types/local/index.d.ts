import {
  ...
  confirmMsg, router, session, local, setPageTemp, tempData, getAllUrl, getUploadUrl, dealsUrl, getUrl, 
  getParamsUrl, getUrlParams, getBaseUrl, getMainUrl, getServiceUrl, exited, getUser, login, exit, logOut, 
